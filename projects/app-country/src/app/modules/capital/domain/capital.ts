...
import {
  ...
  PostalCode,
  Translation,
} from './interfaces/capital.interface';
export type CapitalProps = InterCapital;
export class Capital {
  ...
  private gini?: { [key: string]: number };

  constructor(Prop: CapitalProps) {
    Object.assign(this, Prop);
  }

  Properties(): CapitalProps {
    return Object.assign({}, this) as unknown as CapitalProps;
  }
}
